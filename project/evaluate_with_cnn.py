...
axs.margins(0)
axs.grid()
fig.savefig('data/models/evaluation_model_with_cnn.png')
plt.show()
...
using CNN", fontsize=12, fontweight='bold')
...
plt.savefig('data/models/evaluation_model_with_cnn.png')
plt.margins(0)
plt.show()
'''
...
plt.subplot(212)
plt.title("TEC predicted for test set on "+prepareParams['station']+" [lat.: "+str(evaluateParams['lat'])+", long.: "+str(evaluateParams['long'])+"]", fontsize=12, fontweight='bold')
