...
axs.margins(0)
axs.grid()
fig.savefig('data/models/evaluation_model_with_gru.png')
plt.show()
...
using GRU", fontsize=12, fontweight='bold')
...
plt.savefig('data/models/evaluation_model_with_gru.png')
plt.margins(0)
plt.show()
