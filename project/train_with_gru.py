...
model.add(GRU(5, activation=_activation1, input_shape=(X.shape[1], _nFeatures)))
...
# fit model
historyFilename='data/models/history_log_'+params2['station']+'_gru.csv'
...
plt.savefig('data/models/train_val_loss_gru.png')
...
model.save('data/models/gru_model_using_'+str(amountOfYearusedForTrain)+'_years_of_data.h5')
